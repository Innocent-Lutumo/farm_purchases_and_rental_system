...
function FarmRentals() {
  ...
  const fetchRentals = useCallback(() => {
    setLoading(true);
    axios
      .get("http://127.0.0.1:8000/api/farmsrent/")
      .then((response) => {
                    ...
                    <Card variant="outlined" sx={{ height: "100%" }}>
                      <CardContent>
                        ...
                        <Box sx={{ mb: 2 }}>
                          ...
                          <Typography variant="body2" sx={{ mb: 0.5 }}>
                            <strong>Rental Rate:</strong> {rental.rental_rate || "N/A"} Tshs/month
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 0.5 }}>
                            <strong>Period:</strong> {rental.rental_period || "N/A"}
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 0.5 }}>
                            <strong>Size:</strong> {rental.farm?.size || "N/A"} acres
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 0.5 }}>
                            <strong>Renter:</strong> {rental.farm?.user || "N/A"}
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 0.5 }}>
                            <strong>Start Date:</strong> {rental.start_date || "N/A"}
                          </Typography>
                          <Typography variant="body2">
                            <strong>End Date:</strong> {rental.end_date || "N/A"}
                          </Typography>
                        </Box>
