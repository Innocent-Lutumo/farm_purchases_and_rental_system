...
export default function Purchases() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await axios.delete(
        `${
          process.env.REACT_APP_API_BASE_URL || "http://127.0.0.1:8000"
        }/api/sale-transactions/${deleteId}/`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      fetchOrders();
    } catch (error) {
  ...
  const handleViewAgreement = (order) => {
    ...
    // Implement actual agreement viewing logic here
  };
          ...
          <Paper sx={{ borderRadius: 3, mb: 3 }}>
            ...
            <Box sx={{ p: 2 }}>
              {filteredOrders.length === 0 ? (
                ...
                >
                  <PurchasesIcon sx={{ fontSize: 64, mb: 2, opacity: 0.5 }} />
                  <Typography variant="h6" gutterBottom>
                    No purchases found
                  </Typography>
                  <Typography variant="body2">
                    {activeTab === 0
                      ? "You haven't made any farm purchases yet."
                      : "No sold-out farms found."}
                  </Typography>
                </Box>
              ) : viewMode === "table" ? (
                <TableContainer>
                        ...
                        return (
                          <TableRow
                            ...
                            sx={{
                              ...
                              backgroundColor: order.farm.is_sold
                                ? "rgba(244, 67, 54, 0.05)"
                                : "inherit",
                              "&:hover": {
                                backgroundColor: order.farm.is_sold
                          ...
                          >
                              ...
                              >
                                ...
                                farmImages.length === 0 ? (
                                  ...
                                  <Avatar
                                    ...
                                    alt={order.farm.name}
                                    onError={() =>
                                      handleImageError(order.id, "avatar")
                                    }
                                    sx={{
                                      width: 40,
                                      height: 40,
                            ...
                            <TableCell>
                              <Box sx={{ display: "flex", gap: 1 }}>
                                {order.contact_info && (
                                  <Tooltip
                                    title={`Phone: ${order.contact_info}`}
                                  >
                                    <PhoneIcon
                                      sx={{
                                        fontSize: 16,
                              ...
                              >
                                ...
                                <Tooltip title="Delete Transaction">
                                  <IconButton
                                    ...
                                    color="error"
                                    onClick={() =>
                                      openConfirmationDialog(order.id)
                                    }
                                    disabled={isDeleting}
                                  >
                                    <DeleteIcon />
                                ...
                                >
                                  <Switch
                                    ...
                                    color={
                                      order.farm.is_sold ? "error" : "success"
                                    }
                                    size="small"
                                  />
                                </Tooltip>
